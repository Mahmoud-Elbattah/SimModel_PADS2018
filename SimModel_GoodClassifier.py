...
def PredictTaskType (feature1Val,feature2Val):
    ...
    #Good classifier deployed at Azure ML
    url = 'https://ussouthcentral.services.azureml.net/workspaces/ee457a75262244d4b299080febd209db/services/3d9f5fa36bcf4062b5544d246838a515/execute?api-version=2.0&details=true'

    api_key = '15LbLsk/pMVcqx0zPsCJpXYGQBJX91fDiNEzYPbx7L+U6P76AlqyuhkJpFs2+EP/F+U+1Xfpz2fDIJIudMICHw=='
...
def SimModel(simulatedTime):
    ...
    taskData = pd.read_csv("Good Classifier.csv")
...
def main():
    ...
    simOutput.to_csv('SimOutput_GoodClassifier.csv')
